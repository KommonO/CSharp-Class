...
namespace OperationDungeon
{
    class Mage : Hero
    {
        ...
        public Mage(string name)
        {
            ...
            this.Speed = 3; //Default speed of a Warrior character is 2? Using 1 for first submission purposes in case I can't add multiple Confirm with the UML Diagram
